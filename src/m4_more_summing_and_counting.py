...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(1, 9, 0.29)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(1, 5, 0.29)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 3
    answer = count_cosines_from(1, 7, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(1, 8, 0.70)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(1, 11, 0.99)
